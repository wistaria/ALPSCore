...
TEST(ExpressionTest, SimpleDouble) {
  EXPECT_DOUBLE_EQ(3, alps::evaluate("3"));
  EXPECT_DOUBLE_EQ(3 + 1, alps::evaluate("3 + 1"));
  EXPECT_DOUBLE_EQ(3.5 * 2.1, alps::evaluate("3.5 * 2.1"));
  EXPECT_DOUBLE_EQ(3.5 / 2.1, alps::evaluate("3.5 / 2.1"));
  EXPECT_DOUBLE_EQ((3.5 + 0.3) / 2.1, alps::evaluate("(3.5 + 0.3) / 2.1"));
  EXPECT_DOUBLE_EQ(2 * M_PI, alps::evaluate("2 * Pi"));
