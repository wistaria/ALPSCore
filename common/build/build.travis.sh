...
-DCMAKE_CXX_FLAGS="-Wall -Wno-missing-braces -Wno-int-in-bool-context -Wmissing-field-initializers -Wno-unknown-warning-option -Werror ${mpi_warning_hack}"   \
...
time env ALPS_TEST_MPI_NPROC=$[$ncores+1] make test ARGS="-V"
make install
